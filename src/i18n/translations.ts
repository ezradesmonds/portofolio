...
export const translations = {
  en: {
    ...
    "hero.credential.real": "Real",
    "hero.credential.pixel": "Pixel",
    "hero.credential.showPixel": "Show pixel portrait",
    "hero.credential.showReal": "Show real portrait",
    "hero.credential.portraitAlt": "Portrait of Ezra Desmond Sutanto",
  ...
  id: {
    ...
    "hero.linkedin": "LinkedIn",
    "hero.instagram": "Instagram",
    "hero.credential.real": "Nyata",
    "hero.credential.pixel": "Piksel",
    "hero.credential.showPixel": "Tampilkan potret piksel",
    "hero.credential.showReal": "Tampilkan potret asli",
    "hero.credential.portraitAlt": "Potret Ezra Desmond Sutanto",
    "hero.codeBlock.title": "ezra.ts",
    "hero.codeBlock.focus": "Execution Systems",
    "hero.codeBlock.stacks": ["Full-Stack Web", "AI & ML Integration", "Product Engineering"],
